#!/usr/bin/env python3
"""Write a deterministic declared-package validation report for a Kepler survey."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate a declared-package validation report for a Kepler survey."
    )
    parser.add_argument(
        "survey_dir",
        type=Path,
...
def main() -> int:
    ...
    try:
        ...
        report = validation_report_for_cli(
            args.survey_dir,
            profile=profile,
            profile_sha256=profile_sha256,
        )
    except (OperationalError, SurveyPackageError) as exc:
